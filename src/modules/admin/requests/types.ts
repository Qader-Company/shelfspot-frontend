export type AdminRequestStatus = "draft" | "pending" | "failed" | "in_progress" | "canceled" | "in_review" | "accepted" | "rejected" | "reopened";
...
export interface AdminRequestParams { search?: string; status?: string; companyDeleted?: boolean; page: number; perPage: number }
