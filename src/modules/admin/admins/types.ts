...
export interface Admin { id: Id; name: string; email: string; phone?: string; phone_number?: string; active?: boolean; is_active?: boolean | number; role?: string | Role; roles?: Array<string | Role> }
export interface ListResult<T> { items: T[]; meta?: { current_page?: number; last_page?: number; total?: number } }
