...
import { useForceDeleteTrashMutation, useRestoreTrashMutation, useTrashQuery } from "@/modules/company/dashboard/hooks/use-trash";
import type { TrashItem, TrashResource } from "@/modules/company/dashboard/services/trash-service";
